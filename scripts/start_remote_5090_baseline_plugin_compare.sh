...
RUN_ID="baseline_plugin_5090_$(date -u +%Y%m%dT%H%M%SZ)"
SUITE_PATH="experiments/baseline_plugin_5090_compare.json"
MAX_WORKERS="1"
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/codex-5090-baselines.XXXXXX")"
...
echo "5090 baseline/plugin comparison submitted: ${RUN_ID}"
